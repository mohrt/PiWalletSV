...
#
# Pi Zero W / Zero 2 W with stock Bookworm/Trixie often use full KMS
# (vc4-kms-v3d) and disable_fw_kms_setup=1. Without a monitor at DRM init
# that can leave no /dev/fb0 and HDMI stays black after early boot text.
#
