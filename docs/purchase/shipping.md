...
Typical transit (after we ship — usually within a few business days of payment):
...
## International orders — import duties

International shipments are sent **DDU** (duties unpaid): your country’s customs may
charge **import tax or duty** on delivery. That is separate from the shipping fee
collected at checkout and is **your responsibility**.
