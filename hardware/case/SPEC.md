...
enclosure** that holds a Raspberry Pi Zero 2 W,
...
| # | Decision | Reasoning |
|---|---|---|
| 1 | 2-piece clamshell (back tub + front lid) | Standard enclosure topology, for Pi signer builds. Tub holds all the internal mounting (camera, Pi standoffs, screw bosses); lid carries only the user-facing cutouts. Lid skirt takes shear load; screws are pulling-only. |
