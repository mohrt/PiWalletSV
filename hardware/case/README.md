...
| [`CASE-RESEARCH.md`](CASE-RESEARCH.md) | Survey of prior-art enclosures (SeedSigner, Pi Zero + Camera v3 cases on Printables, parametric Pi Zero SCADs). What we're stealing, what we're skipping, what we corrected against datasheets. |
