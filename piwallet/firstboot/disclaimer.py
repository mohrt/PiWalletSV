...
DEFAULT_DISCLAIMER_PAGES: tuple[DisclaimerPage, ...] = (
    DisclaimerPage(
        title="Beta software",
        body=(
            "PiWalletSV is beta. Expect bugs. Keys and seed phrase "
            "stay on the Pi. Restore from any BIP44-compatible wallet "
            "with your seed phrase — PiWalletSV is not required."
        ),
