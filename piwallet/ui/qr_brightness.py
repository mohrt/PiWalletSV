"""QR quiet-zone luminance — SeedSigner-style live adjustment.

Phone cameras clip a bright TFT quiet zone. We keep modules black and
dim only the QR *background* (not the whole panel). Levels match
SeedSigner: 31–255 in steps of 31, default 62.
"""
...
#: Default QR background level (~24% grey). SeedSigner uses the same.
